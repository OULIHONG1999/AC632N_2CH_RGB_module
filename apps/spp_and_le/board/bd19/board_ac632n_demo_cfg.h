...
#define TCFG_UART0_RX_PORT					IO_PORTB_02                         //串口接收脚配置（用于打印可以选择NO_CONFIG_PORT）
...
//                                 irkey 配置                                      //
//*********************************************************************************//
#define TCFG_IRKEY_ENABLE                   1//DISABLE_THIS_MOUDLE//是否使能AD按键
#define TCFG_IRKEY_PORT                     IO_PORTB_06        //IR按键端口
